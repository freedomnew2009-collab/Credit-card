...
- แยกได้หลายบัตร ตั้งชื่อ เลือกสี และกำหนดวันตัดรอบบิลของแต่ละบัตร
- จดรายการ: วันที่ / ชื่อรายการ / ราคา / สถานที่
- รวมยอดอัตโนมัติ: ยอดรอบบิลนี้, ค้างจ่ายต่อบัตร, ค้างจ่ายรวมทุกบัตร
- ติ๊ก "จ่ายแล้ว / ยังไม่จ่าย" ทีละรายการ หรือกดปุ่มเดียว **จ่ายทั้งรอบบิล**
- เลื่อนดูย้อนหลัง/ล่วงหน้าทีละรอบบิล
- ส่งออกเป็นไฟล์ CSV เปิดใน Excel / Google Sheets ได้
- ใช้บนมือถือได้ดี กด "เพิ่มไปยังหน้าจอโฮม" ใช้เหมือนแอปได้
...
- ถ้าตั้ง **วันตัดรอบ** ของบัตร เช่น วันที่ 25 → รอบบิลคือ 26 ของเดือนก่อน ถึง 25 ของเดือนนี้
- ถ้าไม่ตั้ง → ใช้รอบเดือนปฏิทิน (1 – สิ้นเดือน)
- ปุ่ม **จ่ายทั้งรอบนี้** จะติ๊กจ่ายเฉพาะรายการในรอบบิลที่กำลังดูอยู่เท่านั้น
